    ...
    if (fileExists(mapFilePath)) {
        ...
        if (jsonBuf) {
            ...
            while (jsonMap) {
                ...
                if (strncmp(algoId,
                    getJsonObject(jsonMap, "algo_id", 1,
                        "'algo_id' not found in algo-cracker file!")
                        ->valuestring, strlen(algoId)) == 0) {
                    return getJsonObject(jsonMap, "cracker", 1,
            ...
            if (strlen(crackerName) > 0) { // Cracker determined
                ...
                if (fileGetContents(&strBuf, pathBuf,
                    ...
                    if (jsonBuf) {
                        ...
                        if (crackerArgJson) {
                            strcpy(crackerArgs, crackerArgJson->valuestring);
                        }

                        // Replace CHAR1
                        strcpy(crackerArgs,
                            strReplace(crackerArgs, "CHAR1", char1));

                        // Replace CHAR2
                        strcpy(crackerArgs,
                            strReplace(crackerArgs, "CHAR2", char2));

                        // Replace CHAR3
                        strcpy(crackerArgs,
                            strReplace(crackerArgs, "CHAR3", char3));

                        // Replace CHAR4
                        strcpy(crackerArgs,
                            strReplace(crackerArgs, "CHAR4", char4));
                        ...
                        if (!crackerArgJson)
                            return;
                        strcpy(crackerArgs,
                            strReplace(crackerArgs, "ALGO_ID",
                                crackerArgJson->valuestring));
                        ...
                        if (!crackerArgJson)
                            return;
                        strcpy(crackerArgs,
                            strReplace(crackerArgs, "ALGO_NAME",
                                crackerArgJson->valuestring));
                        ...
                        if (!crackerArgJson)
                            return;
                        strcpy(crackerArgs,
                            strReplace(crackerArgs, "LEN_MIN",
                                crackerArgJson->valuestring));
